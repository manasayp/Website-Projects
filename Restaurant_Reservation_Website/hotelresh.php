               ...
               <div class="s-12 m-6 l-6">
                  ...
                  <p><?php 
					if (isset($_SESSION['email'])){ 
						echo "You are logged in as :";  echo $_SESSION['email']; echo "&nbsp;|<a href='logout.php' style='color:#000000;'>Logout</a>";
					}else { }
				?></p>
...
print "<div id='div_hotel' action='menu.php' method='post'>";
print "<table  id='tbl' border='0' width='30%' align='center'>"; 
 while ($row = mysqli_fetch_assoc($sql)) {
	 
print "<tr>";
//print"<td> ".$row['hid']." </td>";
print"<td> <a href='menu.php?hotelname=".$row['hname']."&hotelid=".$row['hid']."'>".$row['hname']."</a></td>"; 
print "</tr>";
