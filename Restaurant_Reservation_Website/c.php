...
print"<input type='hidden' value='".$row['hname']."' name='hotelname'>";
print "</tr>";
...
<figure>This is the content for Layout Figure Tag<figcaption>This is the caption for Layout Figure Tag</figcaption></figure>         <div class="line">
            <div class="s-12 l-6">
